    ...
    <div className="page-enter mx-auto max-w-6xl px-6 py-10">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        <div>
          ...
          <p className="text-sm text-slate-600 mt-2">{campaign.city}, {campaign.state}, {campaign.country}</p>
          ...
          <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <div className="mt-4 grid gap-3 text-sm">
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-slate-900">{campaign.city}, {campaign.state}, {campaign.country}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-slate-500">Price</span>
                <span className="font-extrabold text-slate-900">{campaign.priceLabel}</span>
              </div>
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <a
                  href={`https://wa.me/${campaign.whatsappNumber}`}
                  target="_blank"
                  rel="noreferrer"
      ...
      <div className="mt-10 rounded-3xl border border-slate-200 bg-white p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-2xl font-black text-slate-900">{formatCurrency(campaign.creditPack, currency)} Credits</p>
          ...
          >
            Buy {formatCurrency(campaign.creditPack, currency)} Credits
          </button>
        </div>
      </div>
